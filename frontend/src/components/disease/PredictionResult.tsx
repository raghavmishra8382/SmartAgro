            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-2">
                    <div className="flex items-center gap-2">
                        <span className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${isHealthy ? 'text-forest-600 bg-forest-50' : 'text-rose-600 bg-rose-50'}`}>
                            <div className={`w-1.5 h-1.5 rounded-full animate-ping ${isHealthy ? 'bg-forest-500' : 'bg-rose-500'}`} />
                ...
                <div className="flex items-center gap-4 bg-slate-50 px-6 py-4 rounded-2xl border border-slate-100">
                    <div className={`p-3 rounded-xl ${isHealthy ? 'bg-forest-500 text-white' : 'bg-rose-500 text-white shadow-lg shadow-rose-200'}`}>
                    ...
                    <div>
                        ...
                        <p className={`text-xl font-black ${isHealthy ? 'text-forest-600' : 'text-rose-600'}`}>
